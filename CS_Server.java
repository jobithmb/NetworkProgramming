...
public class CS_Server {
	...
	public static void main(String[] args) {
		...
		try{
	        ...
	        //int checksum = Integer.parseInt((scan.next()), 16);
			...
			System.out.println("Data received: "+resArray[0]);
			System.out.println("Cksm received: "+resArray[1]);
			
			String input = resArray[0];
			int checksum = Integer.parseInt(resArray[1], 16);
